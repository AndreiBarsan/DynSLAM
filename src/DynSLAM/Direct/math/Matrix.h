  ...
  namespace Common
  {
	...
	public:
		...
		_CPU_AND_GPU_CODE_ Matrix4(T a00, T a01, T a02, T a03, T a10, T a11, T a12, T a13, T a20, T a21, T a22, T a23, T a30, T a31, T a32, T a33)	{
			this->m00 = a00; this->m10 = a01; this->m20 = a02; this->m30 = a03;
			this->m01 = a10; this->m11 = a11; this->m21 = a12; this->m31 = a13;
			this->m02 = a20; this->m12 = a21; this->m22 = a22; this->m32 = a23;
			this->m03 = a30; this->m13 = a31; this->m23 = a32; this->m33 = a33;
		}
	...
	public:
		...
		_CPU_AND_GPU_CODE_ Matrix3(T a00, T a01, T a02, T a10, T a11, T a12, T a20, T a21, T a22)	{
			this->m00 = a00; this->m10 = a01; this->m20 = a02;
			this->m01 = a10; this->m11 = a11; this->m21 = a12;
			this->m02 = a20; this->m12 = a21; this->m22 = a22;
		}
		...
		_CPU_AND_GPU_CODE_ inline void setScale(T s) { this->m00 = this->m11 = this->m22 = s; }
		_CPU_AND_GPU_CODE_ inline void setScale(const Vector3_<T> &s) { this->m00 = s[0]; this->m11 = s[1]; this->m22 = s[2]; }
		_CPU_AND_GPU_CODE_ inline void setRow(int r, const Vector3<T> &t){ for (int x = 0; x < 3; x++) at(x, r) = t[x]; }
